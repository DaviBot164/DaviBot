...
async function initializeSchema() {
     ...
     * ======================================================
     *
     * Stores every Incident generated by
     * Umbra Black Box.
     */
    ...
    /*
     * Recent Incident lookup.
     */

    await query(`
        CREATE INDEX IF NOT EXISTS
            terminal_incidents_guild_created_index
    ...
    await query(`
        CREATE INDEX IF NOT EXISTS
            terminal_incidents_severity_index
    ...
    await query(`
        CREATE INDEX IF NOT EXISTS
            terminal_incidents_service_history_index
    ...
    await query(`
        CREATE INDEX IF NOT EXISTS
            terminal_services_status_index
    ...
    await query(`
        CREATE INDEX IF NOT EXISTS
            terminal_services_severity_index
    ...
    await query(`
        CREATE INDEX IF NOT EXISTS
            terminal_services_checked_index
     ...
     *
     * The DO blocks make this safe for
     * both existing and fresh databases.
     */
    ...
    await query(`
        CREATE INDEX IF NOT EXISTS
            terminal_incidents_created_at_index
    ...
    /*
     * Detect stale Services whose heartbeat
     * has not been updated recently.
     */

    await query(`
        CREATE INDEX IF NOT EXISTS
            terminal_services_last_checked_index
    ...
    await query(`
        CREATE INDEX IF NOT EXISTS
            terminal_services_last_changed_index
    ...
    /*
     * Administrative diagnostics and
     * future Service Registry cleanup.
     */

    await query(`
        CREATE INDEX IF NOT EXISTS
            terminal_services_updated_index
